...
import com.test.ui.TestActivity;
...
public class GlobalVariables {
	...
	public final static String ROOT_PATH = android.os.Environment.getExternalStorageDirectory() + "/com.test/";// 根目录
	...
	public static final String BASE_URL = "http://129.204.162.61:10000/";
	public static final String NETTY_IP = "129.204.162.61";
	public static boolean isCompare = false;
	public static TestActivity tac = null;
}
